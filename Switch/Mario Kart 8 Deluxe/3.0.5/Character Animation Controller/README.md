...
Allows controlling character animations.

Hold `Right Stick In` and press `Left Stick In` to toggle animation mode.

When animation mode is enabled, hold `Right Stick In` and push `Left Stick Left/Right` to cycle through animations.
